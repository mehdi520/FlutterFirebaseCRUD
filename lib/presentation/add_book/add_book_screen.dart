...
class AddBookScreen extends StatelessWidget {
  ...
  void _signup(BuildContext context) async {
    ...
    BaseResponse resp = await bookRepository.createBook(req);
     _overlayService.hideLoadingOverlay();

    if(resp.success)
    {
      context.flushBarSuccessMessage(message: "Book saved successfully.");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('New Book',style: TextStyle(color: AppColors.white,fontWeight: FontWeight.bold),),
        ...
        child: Padding(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                SizedBox(height: 15),
                Text('Please fill below form to add a new book',
